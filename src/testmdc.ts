...
let myStyle = html`
    ...
    <link rel="stylesheet" type="text/css" href="https://unpkg.com/material-components-web@0.8.0/dist/material-components-web.min.css">
`
let  testmdc = () => html`
${myStyle}
<div id="testmdc_container" class="mdc-components">
            ...
            <div dir-horizontal="" class="mdc-component__containers">
              <div class="mdc-component__containers__primary mdc-component__containers__primary__only">
                ...
                <div class="mdc-snackbar" aria-live="assertive" aria-atomic="true" aria-hidden="true">
                  ...
                  <div class="mdc-snackbar__action-wrapper"><button type="button" class="mdc-button mdc-snackbar__action-button" style="color: rgb(255, 193, 7);">Action</button></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="mdc-component__section">
          <div class="mdc-component__containers__primary">
            <div class="mdc-card">
              ...
              <section class="mdc-card__actions"><button type="button" class="mdc-button mdc-button--raised mdc--theme-primary">Button</button></section>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="mdc-component__section__content__frame">
              ...
              <main>
                <div class="cover-image__frame">
                  ...
                  </section><button class="mdc-fab material-icons mdc--theme-primary" aria-label="Add"><span class="mdc-fab__icon">add</span></button></div>
...
const el = document.querySelector('#testmdc_container');
renderLit(testmdc(), el as Element);
